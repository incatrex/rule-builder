...
- configure a VS Code .devcontainer that for this project that can run both a Java backend and React frontend application
...
- A java backend that serves the React application and provides an API endpoints for the following:
