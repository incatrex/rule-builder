...
/**
 * CustomConditionGroup Component - Recursive component for building condition groups
 * 
 * A group contains:
 * - Name (editable)
 * - Conjunction (AND/OR)
 ...
 */
const CustomConditionGroup = ({ value, onChange, onRemove, config, level = 0, darkMode = false }) => {
...
export default CustomConditionGroup;
